...
public class DeductionsForm extends VerticalLayout {
    ...
    TextField eid = new TextField("EmployeeTable ID");
    ...
    private void onSave() {
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            int rs;
            String sql = "update sal_deductions set eid ='" + newEid + "',from_date = '" + newFromDate + "',to_date ='" + newToDate + "',remarks = '" + newRemarks + "' where eid='" + originalEid + "' and from_date = '"+originalFromDate+"' and to_date ='"+originalToDate+"';";
    ...
    private void onDelete() {
        try {
            ...
            int rs;
            String sql;
            sql = "delete from sal_deductions where eid = '" + eid.getValue() + "' and from_date = '"+originalFromDate+"' and to_date ='"+originalToDate+"';";
            rs = stmt.executeUpdate(sql);
            if (rs > 0)
